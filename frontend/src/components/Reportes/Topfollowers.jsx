...
const columns = [
    ...
    { id: 'column4', label: 'Seguidores', align: 'left', minWidth: 100 },
    // Agrega más columnas si es necesario
  ];
  
export function Topfollowers() {

    const [name, setName] = useState("");
    const [page, setPage] = useState(0);
    const [rowsPerPage, setRowsPerPage] = useState(6);
    const [rows, setRows] = useState([
        { code: 'xs', column1: '1', column2: 'Alberto Gonzales', column3: 'Alberto', column4: '10' },
        { code: 'sm', column1: '2', column2: 'Juan Perez', column3: 'Juan', column4: '50' },
        { code: 'md', column1: '3', column2: 'Maria Lopez', column3: 'Maria', column4: '20' },
        { code: 'lg', column1: '4', column2: 'Pedro Rodriguez', column3: 'Pedro', column4: '30' },
        { code: 'xl', column1: '5', column2: 'Jose Hernandez', column3: 'Jose', column4: '25' },
        { code: 'xr', column1: '6', column2: 'Alberto Gonzales', column3: 'Alberto', column4: '1500' },
      ]);
    ...
    const getPerfil = async () => {
        ...
        try {
            console.log(data)
            const result = (await axios.post(`${process.env.REACT_APP_API_URL}api=admin&id=topfollowers`, data, auth)).data
